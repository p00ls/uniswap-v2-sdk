...
describe('Trade', () => {
  ...
  describe('#bestTradeExactIn', () => {
    it('throws with empty pairs', () => {
      expect(() =>
        Trade.bestTradeExactIn([], CurrencyAmount.fromRawAmount(token0, JSBI.BigInt(100)), token2, JSBI.BigInt(3))
      ).toThrow('PAIRS')
    })
  ...
  describe('#bestTradeExactOut', () => {
    it('throws with empty pairs', () => {
      expect(() =>
        Trade.bestTradeExactOut([], token0, CurrencyAmount.fromRawAmount(token2, JSBI.BigInt(100)), JSBI.BigInt(3))
      ).toThrow('PAIRS')
    })
    it('throws with max hops of 0', () => {
      expect(() =>
